...
import br.com.fiap.mentorapp.data.COLLECTION_CHAT
import br.com.fiap.mentorapp.data.COLLECTION_MESSAGES
import br.com.fiap.mentorapp.data.COLLECTION_USER
import br.com.fiap.mentorapp.data.ChatData
import br.com.fiap.mentorapp.data.ChatUser
import br.com.fiap.mentorapp.data.Event
import br.com.fiap.mentorapp.data.Message
import br.com.fiap.mentorapp.data.UserData
import br.com.fiap.mentorapp.ui.Gender
...
//        auth.signOut()
    ...
    private fun handleException(exception: Exception? = null, customMessage: String = "") {
        Log.e("MentorApp", "Mentor exception", exception)
    ...
    private fun populateCards() {
        ...
        val cardsQuery =
            when (Gender.valueOf(gPref)) {
                ...
                Gender.MENTEE -> db.collection(COLLECTION_USER)
                    .whereEqualTo("gender", Gender.MENTEE)
